  ...
  return (
    <>
      ...
      <div className="menu-container flex flex-col justify-center items-center">
        ...
        <div className="grid place-content-center rounded-md border p-3 text-xs">
          <div className="flex-row justify-center text-sm xs:text-xs font-bold text-zinc-600 whitespace-nowrap mb-1 flex items-center gap-6">
            <span>{aggregatedDiscountInfoV2?.descriptionList[1]?.meta}</span>
          </div>
        </div>
      </div>
      {/* ----------------Dishes Accordions------------------------- */}
